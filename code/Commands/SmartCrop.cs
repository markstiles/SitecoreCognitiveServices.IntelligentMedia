...
{
    [Serializable]
    public class SmartCrop : BaseIntelligentMediaCommand
    {
        public virtual void Run(ClientPipelineArgs args)
        {
            ...
            ModalDialogOptions mdo = new ModalDialogOptions($"/SitecoreCognitiveServices/IntelligentMedia/SmartCrop?id={Id}&language={Language}&db={Db}")
            {
                Header = "Smart Crop",
                Height = "400",
                Width = "650",
